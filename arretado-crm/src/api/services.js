...
export const pedidosApi = {
  ...
  // params: { canal, status, sem_cliente, search, page }
  listar:          (params = {}) => api.get('/pedidos/', { params }),

  // Detalhe de um pedido unificado
  detalhe:         (id)          => api.get(`/pedidos/${id}/`),

  // Contagem de pedidos sem cliente vinculado por canal (badge do Sidebar)
  semCliente:      ()            => api.get('/pedidos/sem-cliente/'),

  // Vincula (cliente_id: number) ou desvincula (cliente_id: null)
...
export const authApi = {
  login: async (email, password) => {
    // Substituir por endpoint real quando disponível:
