...
│   └── wsgi.py
├── empresas/                    ← Multi-Empresa (Fases 0-1 de 6, ver MULTIEMPRESA.md) — model Empresa (multi-tenant
│   │                               por linha), consumido por `ifood/` (Fase 1: ConfiguracaoIFood/PedidoIFood
│   │                               + PedidoUnificado, ver ifood/) — Fases 2-5 pendentes (Usuários/empresa
│   │                               ativa, Temas, Financeiro, Dashboard/Relatórios)
