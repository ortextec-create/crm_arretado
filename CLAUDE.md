...
GET                   /api/v1/eventos/{id}/resumo-cozinha/               ← AllowAny · PDF operacional (itens agrupados por categoria, sem preço) · ?imagens=1 inclui folha separada com as imagens de inspiração · ver "Resumo de Cozinha"
